    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.data.videos && result.data.videos.length > 0) {
          ...
          // Show first 5 videos
          const videosToShow = result.data.videos.slice(0, 5);
          ...
          if (result.data.videos.length > 5) {
            resultMessage += `\n... and ${result.data.videos.length - 5} more videos`;
          }
        }
